  ...
  url: string
    ...
    <div style="text-align: left; max-width: 500px; padding: 10px">
      <img
        ...
        style="max-width: 170px; margin-left: 0px"
      />
      <h1 style="font-size: 1.5rem">Use this link to create a new user for dundring.com</h1>
      <p>
        You requested a magic login link, but we could not find a user connected to your e-mail address. You can use this link to create a new user. You will be asked to provide a new username.

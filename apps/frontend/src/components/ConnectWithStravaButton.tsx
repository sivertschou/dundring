...
export const ConnectWithStravaButton = () => {
  ...
  const url = `https://www.strava.com/oauth/authorize?client_id=39382&redirect_uri=http://localhost:5173/auth/strava&response_type=code&approval_prompt=auto&scope=read,activity:write`;

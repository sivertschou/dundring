...
export const WebsocketContextProvider = ({
    ...
    socket.onmessage = (e) => {
      ...
      switch (message.type) {
        case WebSocketResponseType.createdGroupSession: {
          addLog(`created group session with id: ${message.room.id}`);
  ...
  }, [activeGroupSession, socket, addLog]);
